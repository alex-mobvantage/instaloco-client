    ...
    return (
      <View style={[commonStyles.containers.base, commonStyles.containers.centered, styles.container]}>
        <ScrollView style={styles.scrollView}>
          <Text style={commonStyles.fonts.base}>LikesForApps® is a web service owned and operated by Mobvantage Marketing Ltd. ( hereinafter “LikesForApps”, the “Site”, the "Service", or the “System”). These terms govern your use of LikesForApps; by using the Service you agree to the terms below. If you do not agree with any part of these terms, or our privacy policy, you may not use the Site.</Text>
          ...
          <Text style={commonStyles.fonts.base}>All text, graphics, user interface, trademarks, logos, sounds, music, artwork and computer code (collectively “Content”), including but not limited to the ‘look and feel’ and arrangement of such Content, contained on this Site is owned and controlled by LikesForApps, or its respective owners, and is protected by copyright and other intellectual property rights and unfair competition laws. No part of the Content may be copied, reproduced, or distributed in any way to any other computer, server, website or other medium without LikesForApps; explicit prior written consent. </Text>

          <Text style={[commonStyles.fonts.base, commonStyles.fonts.bold, commonStyles.fonts.header, styles.sectionHeader]}>Rewards</Text>
          <Text style={commonStyles.fonts.base}>Any credits such as ‘coins’ earned in LikesForApps are not redeemable for cash and cannot be exchanged, resold, or returned for a cash refund (except as required by law). Unused balances are not transferable.</Text>
          ...
          <Text style={commonStyles.fonts.base}>LikesForApps may terminate your right to use the Site and/or Service immediately, without notice to you, if, in our sole discretion, you fail to comply with any of these terms of use or engage in any fraudulent, criminal or other unauthorized activity. LikesForApps reserves the right to terminate your access to the Site and/or Service for any reason at any time without prior notice. Your account will be reset and terminated due to inactivity. </Text>
          ...
          <Text style={commonStyles.fonts.base}>LikesForApps reserves the right at any time to modify this agreement and to impose new or additional terms, conditions, or policies on your use of the Site. Such modifications and additional terms will be effective immediately and incorporated into this agreement. Your continued use of the Site will be deemed acceptance thereof.</Text>

          <Text style={[commonStyles.fonts.base, {marginTop: 12}]}>If you have any questions, complaints, or comments regarding these terms, please contact us at support@LikesForApps.com. We hope you enjoy using the LikesForApps service.</Text>
        </ScrollView>
      </View>
    );
  }
